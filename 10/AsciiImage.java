...
public class AsciiImage
{
    ...
    public ArrayList<AsciiPoint> getPointList() {
	...
	public int[] getNeighbors(int x, int y)
	{
		...
		for (AsciiPoint p : getPointList())
			uniqueChars.add(getPixel(p));
	...
	public boolean equals(Object o)
	{
		...
		{
            for (AsciiPoint p : getPointList())
                if (img.getPixel(p) != this.getPixel(p))
                    isEqual = false;
            else
                isEqual = false;
        }
